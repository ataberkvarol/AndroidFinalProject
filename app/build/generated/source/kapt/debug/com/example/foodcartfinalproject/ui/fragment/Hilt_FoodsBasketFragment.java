...
public abstract class Hilt_FoodsBasketFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FoodsBasketFragment() {
    super();
  }

  Hilt_FoodsBasketFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FoodsBasketFragment_GeneratedInjector) this.generatedComponent()).injectFoodsBasketFragment(UnsafeCasts.<FoodsBasketFragment>unsafeCast(this));
    }
  }
