...
public abstract class Hilt_MainPageFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MainPageFragment() {
    super();
  }

  Hilt_MainPageFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainPageFragment_GeneratedInjector) this.generatedComponent()).injectMainPageFragment(UnsafeCasts.<MainPageFragment>unsafeCast(this));
    }
  }
