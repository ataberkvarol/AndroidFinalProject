...
public abstract class Hilt_FoodsDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FoodsDetailFragment() {
    super();
  }

  Hilt_FoodsDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FoodsDetailFragment_GeneratedInjector) this.generatedComponent()).injectFoodsDetailFragment(UnsafeCasts.<FoodsDetailFragment>unsafeCast(this));
    }
  }
